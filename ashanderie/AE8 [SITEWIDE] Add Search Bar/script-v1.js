      ...
      if (typeof convert != "undefined") {
          ...
          convert.$(document).ready(() => {
              ...
              const returnSearchParams = () => {
                  ...
                  let searchQueryValueParam = parameters.filter(function(param) {
                      return param.name === 'q';
                  })[0];
              ...
              const loadTest = () => {
                  let searchBar = `<div class="search-wrapper"><input class="search-bar" placeholder="Search for jeans, shirts, and more.." /><img src="https://cdn-3.convertexperiments.com/uf/1004931/10041718/andesearchicon.png"  alt="search-icon" /></div>`;
                  ...
                  if (window.matchMedia("(max-width: 959px)").matches) {
                      convert.$(searchBar).insertAfter(`.header-sticky-wrapper .page-width .header-layout`);
                  } else {
                      convert.$(`.header-sticky-wrapper .header-wrapper .header-item .site-nav .site-nav__icons`).prepend(searchBar);
                  }

                  if (window.matchMedia("(max-width: 959px)").matches && returnSearchParams()) {
                      if (href.indexOf("/search") !== -1) {
                          convert.$(".header-sticky-wrapper .page-width .search-wrapper .search-bar").val(returnSearchParams().replace(/\+/g, ' '));
