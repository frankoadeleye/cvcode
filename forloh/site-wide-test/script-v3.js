        ...
        const loadTest = () => {
          convert.$(document).ready(function () {
            ...
            waitForElement('.site-wide-announcements a.announcement-link').then((element)=>{
              ...
              <span class="announcement-link-text">Free USA Shipping $125+ | Lifetime Warranty |<span><a href="https://forloh.com/collections/top-10-best-sellers">SHOP BEST SELLERS</a></span></span>`);
            });
          })
