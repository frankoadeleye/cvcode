      ...
      if (typeof convert != 'undefined') {
          ...
          convert.$(document).ready(() => {
                ...
                convert.$(document).ready(function () {
                  ...
                  waitForElement('.selector-dropdown.flavor').then(element=>{
                    if (convert.$(".selector-dropdown.flavor").val() ==="Strawberry Lemonade 30 Pack 25mg") {
                      $(".js.product-form__input [value='Strawberry Lemonade 30 pack 25mg']").trigger("click");
                    }
                    convert.$(".selector-dropdown.flavor").change(function () {
                      if (convert.$(".selector-dropdown.flavor").val() ==="Strawberry Lemonade 30 Pack 25mg") {
                        ...
                        $(".js.product-form__input [value='Strawberry Lemonade 30 Pack 10mg']").trigger("click");
                      } else if (convert.$(".selector-dropdown.flavor").val() ==="Green Apple 30 Pack 10mg") {
                        $(".js.product-form__input [value='Green Apple 30 Pack 10mg']").trigger("click");
                      }
                    });
                  });
                });
              ...
              if (!convert.$('body').hasClass(testInfo.className)) {
                  ...
                  convert.$('<link href="https://fonts.googleapis.com/css2?family=Mulish:wght@200;300;400;500;600;700;800&display=swap" rel="stylesheet">').appendTo("head");
                  loadTest();
              }
          });
      }
